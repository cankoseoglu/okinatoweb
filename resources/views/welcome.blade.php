...
<div class="wrapper">
    <div class="bg_img" id="bg_triangles"></div>
    ...
    <div class="left color_white hideee">
        ...
        <div class="content">
            ...
            <h2 class="font_serif">
                ...
                First </h2>
            <p>Your new go-to place for buying and selling Bitcoin, Ethereum and other select digital assets. Trading made fast, easy and secure.</p>
            <div class="space_5 hidden-xs"></div>
            <div class="btns">
                <div class="btn background_green2 shw" data-target="subscribe_section"><i class="fa fa-paper-plane-o"></i> Get notified</div>
                <div class="btn bordered shw" data-target="right"><i class="fa fa-angle-double-right"></i> Explore</div>
            </div>
        </div>
    </div>
    <div class="right">
                ...
                <div class="row">
                    <div class="contact">
                        ...
                        <div class="item">
                            ...
                            <p class="color_grey font_bold"></p>
                        </div>
                        <div class="item">
                        ...
                        <div class="item">
                            ...
                            <p class="color_grey font_bold"><a href="tel:+00 123 456 789" class="letter-spacing_1 font_bold"></a></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="subscribe_section">
        <div class="close-mob"><i class="fa fa-close"></i></div>
        <div class=" background_green2 overlay_black_75"></div>
        <div class="d_table">
            <div class="d_table_v">
                <h1 class="font_bold">Get notified!</h1>
                <p>Leave us your details and we will let you know when we have launched.</p>
                <div class="space_10"></div>
...
<script type="text/javascript" src="{{asset('js/triangles.js')}}"></script>
